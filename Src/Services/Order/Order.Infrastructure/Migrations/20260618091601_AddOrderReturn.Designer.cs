...
namespace Order.Infrastructure.Migrations
{
    ...
    [Migration("20260618091601_AddOrderReturn")]
            ...
            modelBuilder.Entity("Order.Domain.Models.Orders", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingAddress", "Order.Domain.Models.Orders.BillingAddress#Address", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingAddress", "Order.Domain.Models.Orders.ShippingAddress#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Order.Domain.Models.Orders", b =>
                {
                    ...
                    b.OwnsMany("Order.Domain.Models.OrderStatusHistory", "StatusHistory", b1 =>
                        {
                            ...
                            b1.HasKey("OrdersId", "__synthesizedOrdinal");
                    ...
                    b.OwnsOne("Order.Domain.Models.Return", "Return", b1 =>
                        {
                            b1.Property<Guid>("OrdersId")
                                .HasColumnType("uniqueidentifier");
